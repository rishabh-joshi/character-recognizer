...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='model_balanced_dense.log', filemode='w',  level=logging.DEBUG, format = log_fmt, datefmt = date_fmt)
    ...
    model = build_convnet()
    train_test(model, X_train, Y_train, X_test, Y_test, 'dense_cnn_balanced.h5')